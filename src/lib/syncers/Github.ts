...
/**
 * Extended Github class with added caching support
 *
 * - Optional and simple in-memory cache
 * - Uses ETag and If-None-Match headers for data expiration
 * - Attempts loading from filesystem on instantiation
 * - Saves to the filesystem on process beforeExit
 *
 */
